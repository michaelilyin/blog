package ru.michaelilyin.vsu.demo.aspects.system.audit;
...
public class AuditAspect {
    ...
    @Pointcut("@annotation(ru.michaelilyin.vsu.demo.annotation.system.audit.AuditBegin)")
    private void auditBeginPointcut() {}

    @Pointcut("@annotation(ru.michaelilyin.vsu.demo.annotation.system.audit.AuditComplete)")
    private void auditCompletePointcut() {}

    @Pointcut("@annotation(ru.michaelilyin.vsu.demo.annotation.system.audit.AuditError)")
