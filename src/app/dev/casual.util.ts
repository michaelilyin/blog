import * as cas from 'casual-browserify/src/casual_browserify.js';
...
export class CasualExtension {

}

export const casual: Casual.Casual & Casual.Generators & CasualExtension = Object.assign(cas, new CasualExtension());
